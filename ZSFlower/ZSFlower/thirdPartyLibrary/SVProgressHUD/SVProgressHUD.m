...
+ (void)showSuccessWithStatus:(NSString *)string {
    [SVProgressHUD showImage:[UIImage imageNamed:@"SVProgressHUD.bundle/success"] status:string];
}

+ (void)showErrorWithStatus:(NSString *)string {
    [SVProgressHUD showImage:[UIImage imageNamed:@"SVProgressHUD.bundle/error"] status:string];
}
...
+ (void)showSuccessWithStatus:(NSString*)string withDuration:(float)duration {
  [[SVProgressHUD sharedView] showImage:[UIImage imageNamed:@"SVProgressHUD.bundle/success"] status:string duration:duration];
}

+ (void)showErrorWithStatus:(NSString *)string withDuration:(float)duration {
  [[SVProgressHUD sharedView] showImage:[UIImage imageNamed:@"SVProgressHUD.bundle/error"] status:string duration:duration];
}
...
- (void)registerNotifications {
    [NOTIFICATION_DEFAULT  addObserver:self 
